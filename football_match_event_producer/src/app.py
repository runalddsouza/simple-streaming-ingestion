...
class FootballMatchEventProducer:
    def __init__(self, producer, topic_name, log, match_id: str, home_team: str, away_team: str):
        ...
        self.duration = 60 * 90  # 90 minutes
...
if __name__ == '__main__':
    ...
    app = FootballMatchEventProducer(kafka_producer, topic, logger, str(uuid.uuid4()), args.home, args.away)
    app.start()
