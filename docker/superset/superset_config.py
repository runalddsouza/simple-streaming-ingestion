...
NATIVE_FILTER_DEFAULT_ROW_LIMIT = 100
# max rows retrieved by filter select auto complete
FILTER_SELECT_ROW_LIMIT = 100
...
CACHE_CONFIG = {
    ...
    "CACHE_DEFAULT_TIMEOUT": int(timedelta(minutes=5).total_seconds()),
...
RESULTS_BACKEND=RedisCache(host=REDIS_HOST, port=REDIS_PORT, db=REDIS_RESULTS_DB, key_prefix='superset_results')
